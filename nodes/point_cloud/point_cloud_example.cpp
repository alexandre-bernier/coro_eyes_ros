...
int main(void)
{
    ...
    /**
     * @section remove_outliers Remove statistical outliers from point cloud
     * @snippet point_cloud_example.cpp Remove outliers
     */
    // [Remove outliers]

    if(!point_cloud.remove_outliers()) {

        cerr << "Something went wrong while removing outliers from point cloud." << endl;
